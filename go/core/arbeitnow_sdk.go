...
import (
	...
	vs "github.com/voxgig-sdk/arbeitnow-sdk/go/utility/struct"
)

type ArbeitnowSDK struct {
	Mode     string
...
func (sdk *ArbeitnowSDK) OptionsMap() map[string]any {
...
func (sdk *ArbeitnowSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ArbeitnowSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ArbeitnowSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArbeitnowSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ArbeitnowSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ArbeitnowSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ArbeitnowSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ArbeitnowSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArbeitnowSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ArbeitnowSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
