# Arbeitnow TypeScript SDK Reference

Complete API reference for the Arbeitnow TypeScript SDK.
...
```ts
new ArbeitnowSDK(options?: object)
```
...
#### `ArbeitnowSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ArbeitnowSDK` instance in test mode.
...
Return the parent `ArbeitnowSDK` instance.
