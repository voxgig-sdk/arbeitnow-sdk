# Arbeitnow SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ArbeitnowSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ArbeitnowSDK(...) and ArbeitnowSDK.test(...) become
#      ArbeitnowSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "arbeitnow_sdk"
_SDK_CLASS = "ArbeitnowSDK"
