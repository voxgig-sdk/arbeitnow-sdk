...
from arbeitnow_sdk.utility import register

# Load features
from arbeitnow_sdk.feature.base_feature import ArbeitnowBaseFeature
from arbeitnow_sdk.features import _has_feature, _make_feature
...
class ArbeitnowSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ArbeitnowUtility()
        self._utility = utility

        from arbeitnow_sdk.config import shared_config
    ...
    def get_utility(self):
        return ArbeitnowUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ArbeitnowSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Job(self, data=None) -> "JobEntity":
        ...
        from arbeitnow_sdk.entity.job_entity import JobEntity
        return JobEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ArbeitnowSDK":
        if sdkopts is None:
            sdkopts = {}
