...
func registerTools(server *mcp.Server, client *sdk.ArbeitnowSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "arbeitnow_list",
		Description: "List records from Arbeitnow. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "arbeitnow_load",
		Description: "Load a single record from Arbeitnow. " +
...
func runOp(client *sdk.ArbeitnowSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ArbeitnowSDK, name string) (sdk.ArbeitnowEntity, error) {
