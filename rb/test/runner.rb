...
module ArbeitnowTestRunner
  ...
  def self.env_override(m)
    live = getenv("ARBEITNOW_TEST_LIVE")
    override = getenv("ARBEITNOW_TEST_OVERRIDE")
    ...
    explain = getenv("ARBEITNOW_TEST_EXPLAIN")
    m["ARBEITNOW_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ArbeitnowTestRunner
Helpers = ArbeitnowHelpers
Vs = VoxgigStruct
