...
class ArbeitnowCacheFeature extends ArbeitnowBaseFeature
{
    ...
    private function _through(ArbeitnowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
