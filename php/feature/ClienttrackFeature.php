...
// Arbeitnow SDK clienttrack feature
...
class ArbeitnowClienttrackFeature extends ArbeitnowBaseFeature
{
    ...
    public function PostConstruct(ArbeitnowContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Arbeitnow-SDK';
