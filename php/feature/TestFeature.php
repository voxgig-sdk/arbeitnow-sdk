...
// Arbeitnow SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ArbeitnowTestFeature extends ArbeitnowBaseFeature
{
    ...
    public function init(ArbeitnowContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ArbeitnowContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ArbeitnowParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ArbeitnowContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ArbeitnowContext $ctx, $op, $args): array
    {
