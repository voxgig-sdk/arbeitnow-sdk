...
The PHP SDK for the Arbeitnow API — an entity-oriented client using PHP conventions.
...
```php
require_once 'arbeitnow_sdk.php';
$client = new ArbeitnowSDK($options);
```
...
```
php/
├── arbeitnow_sdk.php          -- Main SDK class
...
The main class (`arbeitnow_sdk.php`) exports the SDK class
