...
class ArbeitnowTestRunner
{
    ...
    {
        $live = self::getenv('ARBEITNOW_TEST_LIVE');
        $override = self::getenv('ARBEITNOW_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ARBEITNOW_TEST_EXPLAIN');
...
class_alias('ArbeitnowTestRunner', 'Runner');
class_alias('ArbeitnowHelpers', 'Helpers');
