...
// Arbeitnow SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ArbeitnowSDK::test)
...
{
    private const SDK_CLASS = 'ArbeitnowSDK';
    ...
    private const SDK_BASE = 'arbeitnow_sdk';
