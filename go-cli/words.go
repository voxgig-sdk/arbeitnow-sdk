...
func registerSDKWords(r *eng.Registry, client *sdk.ArbeitnowSDK) {
...
func runOp(client *sdk.ArbeitnowSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
