...
class ArbeitnowGraphql
{
    ...
    // equivalent.
    public static function body(ArbeitnowContext $ctx): mixed
    {
    ...
    public static function errors(ArbeitnowContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
