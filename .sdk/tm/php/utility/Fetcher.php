...
class ArbeitnowFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ArbeitnowSDK/1.0)';
    ...
    public static function call(ArbeitnowContext $ctx, string $fullurl, array $fetchdef): array
    {
