...
// Arbeitnow SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ArbeitnowMakeRequest
{
    public static function call(ArbeitnowContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ArbeitnowResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ArbeitnowResponse($fetched);
        } else {
