...
class ArbeitnowRbacFeature extends ArbeitnowBaseFeature
{
    ...
    private function _required(ArbeitnowContext $ctx): ?string
    {
    ...
    private function _reject(ArbeitnowContext $ctx, string $required): void
    {
    ...
    private function _track(ArbeitnowContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
