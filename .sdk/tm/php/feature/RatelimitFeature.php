...
// Arbeitnow SDK ratelimit feature
...
class ArbeitnowRatelimitFeature extends ArbeitnowBaseFeature
{
    ...
    private function _acquire(ArbeitnowContext $ctx): void
    {
    ...
    private function _track(ArbeitnowContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
