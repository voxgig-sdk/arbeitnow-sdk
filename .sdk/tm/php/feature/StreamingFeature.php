...
// Arbeitnow SDK streaming feature
...
class ArbeitnowStreamingFeature extends ArbeitnowBaseFeature
{
    ...
    private function _iterate(ArbeitnowResult $result): \Generator
    {
    ...
    private function _streamable(ArbeitnowContext $ctx): bool
    {
