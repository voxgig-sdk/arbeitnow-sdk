...
class ArbeitnowTimeoutFeature extends ArbeitnowBaseFeature
{
    ...
    private function _with_timeout(ArbeitnowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ArbeitnowContext $_ctx, float $ms): void
    {
        $client = $this->client;
