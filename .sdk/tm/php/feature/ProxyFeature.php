...
class ArbeitnowProxyFeature extends ArbeitnowBaseFeature
{
    ...
    public function init(ArbeitnowContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArbeitnowContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
