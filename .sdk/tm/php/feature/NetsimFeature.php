...
class ArbeitnowNetsimFeature extends ArbeitnowBaseFeature
{
    ...
    private function _simulate(ArbeitnowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ArbeitnowContext $ctx, array $applied): void
    {
        $client = $this->client;
