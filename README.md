...
This is an unofficial SDK for the Arbeitnow public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/arbeitnow` | `npm install @voxgig-sdk/arbeitnow` |
| Python | `voxgig-sdk-arbeitnow` | `pip install voxgig-sdk-arbeitnow` |
| PHP | `voxgig-sdk/arbeitnow` | `composer require voxgig-sdk/arbeitnow` |
| Golang | `github.com/voxgig-sdk/arbeitnow-sdk/go` | `go get github.com/voxgig-sdk/arbeitnow-sdk/go` |
| Ruby | `voxgig-sdk-arbeitnow` | `gem install voxgig-sdk-arbeitnow` |
| Lua | `voxgig-sdk-arbeitnow` | `luarocks install voxgig-sdk-arbeitnow` |
...
- Upstream API: [https://documenter.getpostman.com/view/18545278/UVJbJdKh](https://documenter.getpostman.com/view/18545278/UVJbJdKh)
